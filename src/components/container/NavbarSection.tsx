    ...
    <nav className="w-full bg-transparent py-6 fixed top-0 left-0 z-20">
      <div className="container mx-auto flex items-center justify-between px-4 md:px-12">
        ...
        <div className="hidden md:flex items-center gap-2">
          <a
            href="#faq"
            className="px-7 py-2 rounded-full bg-linear-to-r from-[#FF6B3D] to-[#FF9066] text-white font-semibold shadow hover:from-[#ff7a4d] hover:to-[#ffb088] transition text-base"
          >
            Let's Talk
          </a>
          <button
        ...
        {open && (
          <>
            <button
              ...
              tabIndex={0}
            ></button>
            <div className="fixed inset-0 z-40 md:hidden bg-[#18111A] w-full h-full flex flex-col shadow-2xl animate-slideInLeft">
              {/* Logo and Close */}
              ...
              <ul className="flex flex-col gap-6 px-6 text-white font-medium text-lg">
                <li>
                  <a
                    href="#about"
                    className="hover:text-[#FF6B3D] transition block py-2"
                    onClick={() => setOpen(false)}
                  >
                    About
                  </a>
              ...
              <div className="px-6 mt-8 flex flex-col gap-4">
                ...
                <a
                  href="#faq"
                  className="w-full block px-7 py-3 rounded-full bg-linear-to-r from-[#FF6B3D] to-[#FF9066] text-white font-semibold shadow hover:from-[#ff7a4d] hover:to-[#ffb088] transition text-base text-center"
                  onClick={() => setOpen(false)}
                >
                  Let's Talk
                </a>
